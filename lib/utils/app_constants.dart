class AppConstants {
  ...
  static const String DRINKS_PRODUCT_URI = "/api/products/drinks";
  ...
  static const String PLACE_ORDER_URI = "/api/customer/order/place";
  static const String ORDER_LIST_URI = "/api/customer/order/list";
